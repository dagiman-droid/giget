            ...
            <div class="bg-white shadow rounded-lg mb-6">
                ...
                <div class="w-full mb-8 px-10 pb-8">
                    ...
                    <div class="rounded-md bg-red-50 p-4 !mt-8">
                        ...
                        <div class="ml-3">
                            <h3 class="text-sm font-medium text-red-800">Nulled. <a style="color:red;" href="https://www.fiverr.com/shayanmemon786?up_rollout=true" target="_blank">By ShayanXtreme</a></h3>
                        </div>
                        </div>
                    </div>
...
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Your purchase code','placeholder' => 'Purchase code is ShayanXtreme','model' => 'purchase_code','icon' => 'key']); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Your CodeCanyon username','placeholder' => 'ShayanXtreme','model' => 'username','icon' => 'account']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginala0274761f86638d78e36787c771a294b67c238db)): ?>
<?php $component = $__componentOriginala0274761f86638d78e36787c771a294b67c238db; ?>
...
</div> <?php /**PATH C:\xampp\htdocs\riverr\resources\views/livewire/installation/start.blade.php ENDPATH**/ ?>